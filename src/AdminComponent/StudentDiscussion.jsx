...
const StudentDiscussion = () => {
    ...
    async function getDisscussionData() {
        axios
            .post(`${BASE_URL}/getadmissiondiscussion`, { admissionid: admissionid })
            .then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            axios
                .post(`${BASE_URL}/add_oadmissiondiscussion`, data)
                .then((res) => {
                    setOpen(false);
    ...
    const handleDelete = (id) => {
        ...
        axios
            .post(`${BASE_URL}/oadmissiondiscuss_delete`, data)
            .then((res) => {
                getDisscussionData();
            })
            .catch((err) => {
    ...
    const handleUpdate = (id) => {
        setOpen(true);
        axios
            .post(`${BASE_URL}/oadmissiondiscussion_update`, { u_id: id })
            .then((res) => {
                setUid(res.data[0]);
            })
            .catch((err) => {
