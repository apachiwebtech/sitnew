                                            ...
                                            <div className='row justify-content-center' >
                                                <div className='p-3' style={{ width: "100%" }}>
                                                    ...
                                                    <div className="form-group col-lg-4 ">
                                                            ...
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.dob} placeholder="First Name" name='dob' onChange={onhandleChange} />

                                                        </div>
                                                        <div className="form-group col-lg-4 ">
                                                            <label for="exampleInputUsername1">Middle Name</label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.dob} placeholder="Middle Name" name='dob' onChange={onhandleChange} />

                                                        </div>
                                                        <div className="form-group col-lg-4 ">
                                                            <label for="exampleInputUsername1">Last Name</label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.dob} placeholder="Last Name" name='dob' onChange={onhandleChange} />
                                                        ...
                                                        <div className="form-group col-lg-6 ">
                                                            ...
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.dob} placeholder="Mobile" name='dob' onChange={onhandleChange} />

                                                        </div>
                                                        <div className="form-group col-lg-6 ">
                                                            <label for="exampleInputUsername1">Phone </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="Phone " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>
                                                       
                                                        <div className="form-group col-lg-6 ">
                                                            <label for="exampleInputUsername1">E-Mail </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="E-Mail " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>
                                                        <div className="form-group col-lg-6 ">
                                                            <label for="exampleInputUsername1">Business </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="Business " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>
                                                        <div className="form-group col-lg-6 ">
                                                            <label for="exampleInputUsername1">Company Name  </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="Company Name  " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>
                                                        <div className="form-group col-lg-6 ">
                                                            <label for="exampleInputUsername1">Designation  </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="Designation  " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>

                                                        <div className="form-group col-lg-12 ">
                                                            <label for="exampleInputUsername1">Discussion   </label>
                                                            <input type="text" class="form-control" id="exampleInputUsername1" value={value.firstname} placeholder="Discussion   " name='firstname' onChange={onhandleChange} />
                                                            {error.facultyname && <span className='text-danger'>{error.name}</span>}
                                                        </div>
                                            ...
                                            <div className='row justify-content-center' >
                                                <div className='p-3' style={{ width: "100%" }}>
                                                    ...
                                                    <div className="form-group col-lg-6 ">
                                                            ...
                                                            <select className="form-control form-control-lg" id="exampleFormControlSelect1" value={value.gender} name='course ' onChange={onhandleChange} >
...
<div className="form-group col-lg-12">
    ...
    <textarea className="form-control" id="exampleTextarea1" value='' placeholder="Address" name='discussion' onChange=''></textarea>
...
<div className='form-group col-4'>
    ...
    <input type="number" className="form-control" id="exampleInputUsername1" value='' placeholder="Place" name='mobile' onChange='' />
</div>
