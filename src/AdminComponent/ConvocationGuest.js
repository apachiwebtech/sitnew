                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Convocation Guest List Report</h4>
                                    <hr></hr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div className='d-flex justify-content-between'>
                                        <div>
                                            <h4 class="card-title">Convocation Gest List Report Details</h4>
                                        </div>
...
export default ConvocationGuest
