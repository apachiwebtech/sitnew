      ...
      <Page size="A4" style={styles.page}>
        ...
        <View fixed>
          ...
          <View style={{ display: "flex", flexDirection: "row", marginTop: "0px" }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", border: "1px solid black", flex: "5" }}>
              <View style={{ flex: "7" }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", border: "1px solid black", flex: "5" }}>
              <View style={{ flex: "7" }}>
                <Text style={{ color: "lighgrey", fontSize: "10px", textAlign: "center" }}>Faculty
                </Text>
              </View>
              <View style={{ flex: "3" }}>
                <Text style={{ color: "black", borderLeft: "1px solid black", padding: "0px 10px", fontSize: "10px" }}>Date:
                </Text>
              </View>
          ...
          <View style={{ display: "flex", flexDirection: "row", marginBottom: "0px" }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", border: "1px solid black", flex: "5", padding: "5px 0px" }}>
