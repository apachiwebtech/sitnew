                     ...
                     <div className="col-lg-12 grid-margin stretch-card mt-4">
                         <div className="card">
                             <div className="card-body">
                                 <h2 className="card-title titleback">Leave Structure</h2>
                                 <hr />
                                     ...
                                     <div key={index} className="border p-3 mb-4 rounded bg-light">
                                         <div className="row">
                                             <div className="col-md-2">
                                                 <label>P.L</label>
                                                 <input type="text" className="form-control" name="Company" value={row.PL} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                             <div className="col-md-2">
                                                 <label>S.L</label>
                                                 <input type="text" className="form-control" name="Business_Nature" value={row.SL} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                             <div className="col-md-2">
                                                 <label>C.L</label>
                                                 <input type="text" className="form-control" name="Designation" value={row.CL} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                             <div className="col-md-2">
                                                 <label>From Date</label>
                                                 <input type="text" className="form-control" name="Address" value={row.FromDate} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                             <div className="col-md-2">
                                                 <label>To Date</label>
                                                 <input type="text" className="form-control" name="City" value={row.Todate} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                             
                                             <div className="col-md-2">
                                                 <label>Attain Date</label>
                                                 <input type="date" className="form-control" name="Last_Date" value={row.AttainDate} onChange={(e) => handleInputChange(e, index)} />
                                             </div>
                                         </div>
