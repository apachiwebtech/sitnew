                ...
                <View style={{ border: "2px solid black" }}>
                    ...
                    <View style={styles.Course}>
                        ...
                        <View style={[styles.tableCol, { width: '50%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 5, marginLeft: 5, color: '#000' }}>Name :</Text>
                            <Text style={{ fontSize: '10px', marginTop: 15, color: '#000', marginLeft: 5 }}>ID No :</Text>
                        </View>
                        <View style={[styles.tableCol1, { width: '50%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 5,marginLeft: 5, color: '#000' }}>Training Programme : </Text>
                            <Text style={{ fontSize: '10px', marginTop: 15,marginLeft: 5, color: '#000' }}>Batch No : </Text>
                        </View>
                    ...
                    <View style={styles.Course}>
                        ...
                        <View style={[styles.tableCol1, { width: '50%' }]}>
                            ...
                            <View style={[styles.tableCol10, { width: '100%' }]}>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            ...
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',borderRight: '1px solid black' }}> </Text>
                            <Text style={{ fontSize: '10px', paddingLeft:15,paddingRight:7,paddingTop:4.5, color: '#000',paddingLeft:'20px' }}> </Text></View>
