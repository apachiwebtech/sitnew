...
import AnnualTargetsListing from "./AnnualTargetsListing";
import UpcomingBatchesListing from "./UpcomingBatchesListing";
import EnquiryReport from "./EnquiryReport";
import EnquirySources from "./EnquirySources";
...
const AdminDashBoard = () => {
    ...
    return (
        <div className={`container-fluid page-body-wrapper ${isSidebarOpen ? "col-lg-12" : ""}`}>
            <InnerHeader />
            ...
            <div className="main-panel">
                <div className="content-wrapper">
                    ...
                    <AnnualTargetsListing />
                    <UpcomingBatchesListing />
                    <EnquiryReport />
                    <EnquirySources />
                    <PlacementReport />
                </div>
