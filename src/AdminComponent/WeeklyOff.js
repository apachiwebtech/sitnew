                    ...
                    <div className="col-lg-12 grid-margin stretch-card mt-4">
                        <div className="card">
                            <div className="card-body">
                                <h2 className="card-title titleback">Weekly Off</h2>
                                <hr />
                                    ...
                                    <div key={index} className="border p-3 mb-4 rounded bg-light">
                                        <div className="row">
                                            <div className="col-md-2">
                                                <label>WeekDay</label>
                                                <input type="text" className="form-control" name="Company" value={row.WeekDay} onChange={(e) => handleInputChange(e, index)} />
                                            </div>
                                            <div className="col-md-2">
                                                <label>Date from</label>
                                                <input type="text" className="form-control" name="Business_Nature" value={row.Datefrom} onChange={(e) => handleInputChange(e, index)} />
                                            </div>
                                            <div className="col-md-2">
                                                <label>To Date</label>
                                                <input type="text" className="form-control" name="Designation" value={row.ToDate} onChange={(e) => handleInputChange(e, index)} />
                                            </div>
