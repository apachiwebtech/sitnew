                ...
                <View style={{ border: "2px solid black" }}>
                    ...
                    <View style={styles.Course}>
                        ...
                        <View style={[styles.tableCol1, { width: '30%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000',paddingLeft:'5px', borderBottom: '1px solid black' }}> Total No of Assignments/</Text>
                        ...
                        <View style={[styles.tableCol1, { width: '50%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000', borderBottom: '1px solid black' }}> 0</Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000', borderBottom: '1px solid black' }}>0</Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000', borderBottom: '1px solid black' }}> </Text>
                        
                        
                            <Text style={{ fontSize: '10px', marginTop:16, color: '#000',paddingLeft:'20px', borderBottom: '1px solid black'}}> 0    /0</Text>
                    ...
                    <View style={styles.Course}>
                        ...
                        <View style={[styles.tableCol1, { width: '50%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000',paddingLeft:'20px', borderBottom: '1px solid black' }}> 0</Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000', borderBottom: '1px solid black',paddingLeft:'20px' , borderBottom: '1px solid black'}}> 0</Text>

                            <Text style={{ fontSize: '10px', paddingTop: 4.5, color: '#000', borderBottom: '1px solid black',paddingLeft:'20px' }}> </Text>
                            <Text style={{ fontSize: '10px', marginTop: 16, color: '#000', borderBottom: '1px solid black',paddingLeft:'20px' }}>0          /0 </Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000',paddingLeft:'20px' }}>0.00</Text>
                        </View>
                    ...
                    <View style={styles.Course}>
                        ...
                        <View style={[styles.tableCol1, { width: '50%' }]}>
                            <Text style={{ fontSize: '10px', marginTop: 16, color: '#000',paddingLeft:'20px', borderBottom: '1px solid black' }}>4/4 </Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000',paddingLeft:'20px', borderBottom: '1px solid black' }}>0</Text>
                            <Text style={{ fontSize: '10px', marginTop: 5, color: '#000',paddingLeft:'20px' }}>100.00</Text>
                        </View>
